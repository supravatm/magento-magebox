...
return [
    'modules' => [
        ...
        'SMG_CartItemRenderer' => 1,
        'SMG_CheckoutDeliveryDate' => 1,
        'SMG_CheckoutValidateBeforePlaceOrder' => 1,
        'SMG_ControllerResponseTypes' => 1,
        'SMG_CoreExtended' => 1,
        'SMG_CustomAddProductAttribute' => 1,
        'SMG_CustomCache' => 1,
        'SMG_CustomCommand' => 1,
        'SMG_CustomCron' => 1,
        'SMG_CustomCustomerAttribute' => 1,
        'SMG_CustomFee' => 1,
        'SMG_CustomFieldToQuoteItem' => 1,
        'SMG_CustomPaymentOffline' => 1,
        'SMG_CustomProductAttribute' => 1,
        'SMG_CustomRoute' => 1,
        'SMG_CustomerTelephoneValidate' => 1,
        'SMG_DeliveryCarrier' => 1,
        'SMG_EmailChecker' => 1,
        'SMG_ExemptProductType' => 1,
        'SMG_Minimal' => 1,
        'SMG_News' => 1,
        'SMG_OrderExtensionAttribute' => 1,
        'SMG_PluginExample' => 1,
        'SMG_RestApiProductComment' => 1,
        'SMG_RestApiTest' => 1,
        'SMG_SendOrder' => 1,
        'SMG_WebFlow' => 1
    ]
